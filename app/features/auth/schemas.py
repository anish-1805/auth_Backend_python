...
class AuthResponse(BaseModel):
    ...
    data: Optional[dict[str, str | bool | int]] = None
...
class DeleteUsersRequest(BaseModel):
    ...
    userIds: list[str] = Field(..., min_length=1, description="List of user IDs to delete")
...
class PaginationParams(BaseModel):
    ...
    sortOrder: Optional[str] = Field(default="desc", description="Sort order (asc/desc)")
